#!/usr/bin/env python3
# -*- coding: utf-8 -*-
''' Submit to cluster ERF function '''
import os
...
for s in subNs:
    #sub = sub_codes[s-1]
    submit_cmd = 'python {}APR4a_ERF_analyses.py {}'.format(script_dir,s)
    cb.add_job(cmd=submit_cmd, queue='short.q',n_threads = 1, cleanup = False)
