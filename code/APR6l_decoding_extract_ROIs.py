''' Script for supplemental ROI analyses '''
...
## Comment / uncomment to switch between decoding patterns and ERFs
#suffix = 'patterns_sources_task_sensor_lf_0.05_hf_None_tstep_0.025_twin_0.05_localized' #'Patterns'
suffix = 'evoked_sources_lf_0.05_hf_None_tstep_0.025_twin_0.05'# ERFs
