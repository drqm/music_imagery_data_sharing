''' Script to estimate inverse solution '''
# Append to path
...
# Filename
suffix = '_{}_lf_{}_hf_{}_{}_tmin_{}_tmax_{}'.format(block, l_freq, h_freq, ch_type, tmin, tmax)
...
data_cov = mne.compute_covariance([epochs[e] for e in epochs], 
                                    tmin= np.max([0,tmin]), tmax = tmax, rank ='info')
